...
class CoordonatesTest2 {

    // We are comparing calculated distance using 1mm precision
    private double Precision = 0.001;

    //
    // Base cases: random coordinates points of the planet
    //
    ...
    void distanceNetherlandsNorthToSouthWithPrecision() {
        ...
        double resultDistance = Coordonates.getDistance(lat1, lon1, lat2, lon2);
    ...
    void distanceAustraliaWestToEast() {
        double distance = Coordonates.getDistance(-23.939607, 113.585605, -28.293166, 153.718989);
        assertEquals(4018083.0398, distance, Precision);
    }
    
    @Test
    void distanceFromCapetownToJohannesburg() {
        double distance = Coordonates.getDistance(-33.926510, 18.364603,-26.208450, 28.040572);
        assertEquals(1265065.6094, distance, Precision);
    }

    @Test
    void distanceFromSantiagoToSaoPaolo() {
        double distance = Coordonates.getDistance(-33.464087, -70.660573,-23.553981, -46.630563);
    ...
    void distanceIsTheSameIfMeasuredInBothDirections() {
        ...
        double distanceDirection1 = Coordonates.getDistance(-33.926510, 18.364603,-26.208450, 28.040572);
        double distanceDirection2 = Coordonates.getDistance(-26.208450, 28.040572, -33.926510, 18.364603);
    ...
    void distanceAround180thMeridianFiji() {
        double distance = Coordonates.getDistance(-17.947826, 177.221232, -16.603513, -179.779055);
    ...
    void distanceFrom180ToMinus180LongitudeShouldBeZero() {
        ...
        double distance = Coordonates.getDistance(20, -180, 20, 180);
        assertEquals(0, distance, Precision);
    }

    @Test
    void distanceAround0thMeridianLondon() {
        double distance = Coordonates.getDistance(51.512722, -0.288552, 51.516100, 0.068025);
        assertEquals(24677.4562, distance, Precision);
    }

    //Distances in the Arctic and Antarctica.
    @Test
    void distanceAround90LatitudeArctic() {
        double distance = Coordonates.getDistance(89.9, -179.9, 89.9, 179.9);
    ...
    void distance90LatitudeNorthPole() {
        ...
        double distance = Coordonates.getDistance(90, -179.9, 90, 179.9);
        assertEquals(0, distance, Precision);
    }
    ...
    //This is max distance on the planet
    @Test
    void distanceFromNorthPoleToSouthPole() {
        double distance = Coordonates.getDistance(90, 10, -90, 10);
    ...
    void maxDistanceAlongTheEquator() {
        double distance = Coordonates.getDistance(0, 0, 0, 180);
        assertEquals(20015086.7960, distance, Precision);
    }

    @Test
    void maxDistanceAlongTheEquator2() {
        double distance = Coordonates.getDistance(0, 10, 0, -170);
        assertEquals(20015086.7960, distance, Precision);
    }

    @Test
    void maxDistanceAlongTheEquator3() {
        double distance = Coordonates.getDistance(0, 175, 0, -5);
        assertEquals(20015086.7960, distance, Precision);
    }
    ...
    void verySmallDistance() {
        double distance = Coordonates.getDistance(0, 0, 0.00000001, 0);
        assertEquals(0.001, distance, Precision);
    }

    // If both points are absolutely the same, we are getting 0 m distance
    @Test
    void distanceBetweenTheSamePointsIs0() {
        double distance = Coordonates.getDistance(42,99,42,99);
    ...
    void distanceBetweenTheSamePoints_0_0_Is0() {
        ...
        double distance = Coordonates.getDistance(0,0,0,0);
        assertEquals(0, distance);
    }
    ...
    void invalidLatitude1TooMuch() {
        assertThrows(IllegalArgumentException.class, () -> {
            Coordonates.getDistance(666, 0, 0, 0);
        });
    }
    ...
    void invalidLatitude2TooMuch() {
        assertThrows(IllegalArgumentException.class, () -> {
            Coordonates.getDistance(0, 0, 666, 0);
        });
    }
    ...
    void invalidLongitude1TooMuch() {
        assertThrows(IllegalArgumentException.class, () -> {
            Coordonates.getDistance(0, 666, 0, 0);
        });
    }
    ...
    void invalidLongitude2TooMuch() {
        assertThrows(IllegalArgumentException.class, () -> {
            Coordonates.getDistance(0, 0, 0, 666);
        });
    }
